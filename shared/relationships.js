...
//
// Resource relationship type map. Contains the merged RELATIONSHIP_TYPE_MAP
// data that was previously loaded from js/RelationshipTypeMap.js via VM sandbox.
//
// The data is defined inline and the overrides are merged at module load time.
...
/* Overrides */
var RELATIONSHIP_TYPE_MAP_OVERRIDES = {
  "AWS::Lambda::Function": {
    "Relationships": {
      "IsContainedInside": {
        "AWS::EC2::Subnet": [
...
module.exports = RELATIONSHIP_TYPE_MAP;
