...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("GameLift", "listFleets", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.FleetIds.map(async (fleetId) => {
            await context.sdkcall("GameLift", "describeFleetAttributes", {
                FleetIds: [fleetId]
            }, true).then(async (data) => {
                ...
                await context.sdkcall("GameLift", "describeFleetCapacity", {
                ...
                await context.sdkcall("GameLift", "describeFleetPortSettings", {
                    FleetId: fleet.FleetId
                }, false).then(data => {
    ...
    await context.sdkcall("GameLift", "listBuilds", {
        // no params
    }, true).then(async (data) => {
        data.Builds.forEach(async (build) => {
            await context.sdkcall("GameLift", "requestUploadCredentials", {
    ...
    await context.sdkcall("GameLift", "listAliases", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("GameLift", "listScripts", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("GameLift", "describeGameSessionQueues", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("GameLift", "describeMatchmakingConfigurations", {
        // no params
    }, false).then((data) => {
    ...
    await context.sdkcall("GameLift", "describeMatchmakingRuleSets", {
        // no params
    }, false).then((data) => {
    ...
    await context.sdkcall("GameLift", "listGameServerGroups", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.GameServerGroups.map(async (gameServerGroup) => {
            return context.sdkcall("GameLift", "describeGameServerGroup", {
