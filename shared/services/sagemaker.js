...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("SageMaker", "listCodeRepositories", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.CodeRepositorySummaryList.map(coderepository => {
            return context.sdkcall("SageMaker", "describeCodeRepository", {
    ...
    await context.sdkcall("SageMaker", "listModels", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.Models.map(model => {
            return context.sdkcall("SageMaker", "describeModel", {
    ...
    await context.sdkcall("SageMaker", "listEndpoints", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.Endpoints.map(endpoint => {
            return context.sdkcall("SageMaker", "describeEndpoint", {
    ...
    await context.sdkcall("SageMaker", "listEndpointConfigs", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.EndpointConfigs.map(endpointConfig => {
            return context.sdkcall("SageMaker", "describeEndpointConfig", {
    ...
    await context.sdkcall("SageMaker", "listNotebookInstances", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.NotebookInstances.map(notebookInstance => {
            return context.sdkcall("SageMaker", "describeNotebookInstance", {
    ...
    await context.sdkcall("SageMaker", "listNotebookInstanceLifecycleConfigs", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.NotebookInstanceLifecycleConfigs.map(notebookInstanceLifecycleConfig => {
            return context.sdkcall("SageMaker", "describeNotebookInstanceLifecycleConfig", {
    ...
    await context.sdkcall("SageMaker", "listWorkteams", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.Workteams.map(workteam => {
            return context.sdkcall("SageMaker", "describeWorkteam", {
    ...
    await context.sdkcall("SageMaker", "listMonitoringSchedules", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.MonitoringScheduleSummaries.map(async (monitoringSchedule) => {
            return context.sdkcall("SageMaker", "describeMonitoringSchedule", {
    ...
    await context.sdkcall("SageMaker", "listProjects", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.ProjectSummaryList.map(async (project) => {
            return context.sdkcall("SageMaker", "describeProject", {
    ...
    await context.sdkcall("SageMaker", "listPipelines", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.PipelineSummaries.map(async (pipeline) => {
            return context.sdkcall("SageMaker", "describePipeline", {
    ...
    // DISCONTINUED
    /*
    await context.sdkcall("SageMaker", "listDeviceFleets", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.DeviceFleetSummaries.map(async (devicefleet) => {
            return context.sdkcall("SageMaker", "describeDeviceFleet", {
    ...
    await context.sdkcall("SageMaker", "listDevices", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.DeviceSummaries.map(async (device) => {
            return context.sdkcall("SageMaker", "describeDevice", {
    ...
    */
    ...
    await context.sdkcall("SageMaker", "listModelPackageGroups", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.ModelPackageGroupSummaryList.map(async (modelpackagegroup) => {
            return context.sdkcall("SageMaker", "describeModelPackageGroup", {
    ...
    await context.sdkcall("SageMaker", "listDataQualityJobDefinitions", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.JobDefinitionSummaries.map(async (jobdefinition) => {
            return context.sdkcall("SageMaker", "describeDataQualityJobDefinition", {
    ...
    await context.sdkcall("SageMaker", "listModelBiasJobDefinitions", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.JobDefinitionSummaries.map(async (jobdefinition) => {
            return context.sdkcall("SageMaker", "describeModelBiasJobDefinition", {
                JobDefinitionName: jobdefinition.MonitoringJobDefinitionName
            }, true).then((data) => {
                resources.push({
                    f2id: data.JobDefinitionArn,
    ...
    await context.sdkcall("SageMaker", "listModelExplainabilityJobDefinitions", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.JobDefinitionSummaries.map(async (jobdefinition) => {
            return context.sdkcall("SageMaker", "describeModelExplainabilityJobDefinition", {
                JobDefinitionName: jobdefinition.MonitoringJobDefinitionName
            }, true).then((data) => {
                resources.push({
                    f2id: data.JobDefinitionArn,
    ...
    await context.sdkcall("SageMaker", "listModelQualityJobDefinitions", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.JobDefinitionSummaries.map(async (jobdefinition) => {
            return context.sdkcall("SageMaker", "describeModelQualityJobDefinition", {
                JobDefinitionName: jobdefinition.MonitoringJobDefinitionName
            }, true).then((data) => {
                resources.push({
                    f2id: data.JobDefinitionArn,
    ...
    await context.sdkcall("SageMaker", "listDomains", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.Domains.map(async (domain) => {
            return context.sdkcall("SageMaker", "describeDomain", {
    ...
    await context.sdkcall("SageMaker", "listUserProfiles", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.UserProfiles.map(async (userProfile) => {
            return context.sdkcall("SageMaker", "describeUserProfile", {
    ...
    await context.sdkcall("SageMaker", "listApps", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.Apps.map(async (app) => {
            return context.sdkcall("SageMaker", "describeApp", {
    ...
    await context.sdkcall("SageMaker", "listAppImageConfigs", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.AppImageConfigs.map(async (appImageConfig) => {
            return context.sdkcall("SageMaker", "describeAppImageConfig", {
    ...
    await context.sdkcall("SageMaker", "listImages", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.Images.map(async (image) => {
            await context.sdkcall("SageMaker", "describeImage", {
            ...
            return context.sdkcall("SageMaker", "listImageVersions", {
                ImageName: image.ImageName
            }, false).then(async (data) => {
                await Promise.all(data.ImageVersions.map(async (imageversion) => {
                    return context.sdkcall("SageMaker", "describeImageVersion", {
                        ImageName: image.ImageName,
    ...
    await context.sdkcall("SageMaker", "listFeatureGroups", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.FeatureGroupSummaries.map(async (featuregroup) => {
            return context.sdkcall("SageMaker", "describeFeatureGroup", {
