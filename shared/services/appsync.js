...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("AppSync", "listGraphqlApis", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.graphqlApis.map(graphqlApi => {
            return Promise.all([
                context.sdkcall("AppSync", "listTypes", {
                    apiId: graphqlApi.apiId,
                    format: 'JSON'
                }, true).then(async (data) => {
                    await Promise.all(data.types.map(type => {
                        return context.sdkcall("AppSync", "listResolvers", {
                            apiId: graphqlApi.apiId,
                            typeName: type.name
                        }, true).then((data) => {
                ...
                context.sdkcall("AppSync", "listDataSources", {
                    apiId: graphqlApi.apiId
                }, true).then(async (data) => {
                    await Promise.all(data.dataSources.map(dataSource => {
                        return context.sdkcall("AppSync", "getDataSource", {
                            apiId: graphqlApi.apiId,
                ...
                context.sdkcall("AppSync", "listFunctions", {
                    apiId: graphqlApi.apiId
                }, true).then(async (data) => {
                    await Promise.all(data.functions.map(appSyncFunction => {
                        return context.sdkcall("AppSync", "getFunction", {
                            apiId: graphqlApi.apiId,
                ...
                context.sdkcall("AppSync", "listApiKeys", {
                    apiId: graphqlApi.apiId
                }, true).then((data) => {
                ...
                context.sdkcall("AppSync", "getIntrospectionSchema", {
                    apiId: graphqlApi.apiId,
                    format: 'SDL'
                }, false).then((data) => {
                ...
                context.sdkcall("AppSync", "getApiCache", {
                    apiId: graphqlApi.apiId
                }, false).then((data) => {
                ...
                context.sdkcall("AppSync", "getGraphqlApi", {
                    apiId: graphqlApi.apiId
                }, true).then(async (data) => {
                    data.graphqlApi['Tags'] = await context.getResourceTags(data.graphqlApi.arn);
    ...
    await context.sdkcall("AppSync", "listDomainNames", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.domainNameConfigs.map(async (domainname) => {
            await context.sdkcall("AppSync", "getDomainName", {
            ...
            return context.sdkcall("AppSync", "getApiAssociation", {
                domainName: domainname.domainName
            }, true).then((data) => {
                resources.push({
