...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("DMS", "describeEndpoints", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("DMS", "describeReplicationInstances", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("DMS", "describeReplicationTasks", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("DMS", "describeReplicationSubnetGroups", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("DMS", "describeCertificates", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("DMS", "describeEventSubscriptions", {
        // no params
    }, true).then((data) => {
