...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("AppStream", "describeFleets", {
        // no params
        ...
        await Promise.all(data.Fleets.map(async (fleet) => {
            ...
            await context.sdkcall("AppStream", "describeApplicationFleetAssociations", {
            ...
            return context.sdkcall("AppStream", "listAssociatedStacks", {
                FleetName: fleet.Name
            }, true).then((data) => {
    ...
    await context.sdkcall("AppStream", "describeUsers", {
    ...
    await context.sdkcall("AppStream", "describeStacks", {
        // no params
    }, true).then((data) => {
        data.Stacks.forEach(async (stack) => {
            ...
            await context.sdkcall("AppStream", "describeUserStackAssociations", {
            ...
            await context.sdkcall("AppStream", "describeEntitlements", {
                StackName: stack.Name
            }, true).then(async (data) => {
                data.Entitlements.forEach(async (entitlement) => {
                    ...
                    await context.sdkcall("AppStream", "listEntitledApplications", {
    ...
    await context.sdkcall("AppStream", "describeImageBuilders", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("AppStream", "describeDirectoryConfigs", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("AppStream", "describeApplications", {
        // no params
    }, true).then(async (data) => {
    ...
    await context.sdkcall("AppStream", "describeAppBlocks", {
        // no params
    }, true).then(async (data) => {
