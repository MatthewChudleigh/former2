...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("DocDB", "describeDBClusters", {
        Filters: [{
            Name: 'engine',
            Values: ['docdb']
        }]
    ...
    await context.sdkcall("DocDB", "describeDBInstances", {
        Filters: [{
            Name: 'engine',
            Values: ['docdb']
        }]
    ...
    await context.sdkcall("DocDB", "describeDBClusterParameterGroups", {
        Filters: [{
            Name: 'engine',
            Values: ['docdb']
        }]
        ...
        await Promise.all(data.DBClusterParameterGroups.map(parameterGroup => {
            return context.sdkcall("DocDB", "describeDBClusterParameters", {
    ...
    await context.sdkcall("DocDB", "describeDBSubnetGroups", {
        Filters: [{
            Name: 'engine',
            Values: ['docdb']
        }]
