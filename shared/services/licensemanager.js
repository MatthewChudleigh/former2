...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("LicenseManager", "listLicenses", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.Licenses.map(license => {
            return context.sdkcall("LicenseManager", "getLicense", {
    ...
    await context.sdkcall("LicenseManager", "listDistributedGrants", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.Grants.map(grant => {
            return context.sdkcall("LicenseManager", "getGrant", {
    ...
    await context.sdkcall("LicenseManager", "listLicenseConfigurations", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.LicenseConfigurations.map(licenseconfiguration => {
            return context.sdkcall("LicenseManager", "getLicenseConfiguration", {
                ...
                await context.sdkcall("LicenseManager", "listAssociationsForLicenseConfiguration", {
                    LicenseConfigurationArn: licenseconfiguration.LicenseConfigurationArn
                }, true).then(async (data) => {
