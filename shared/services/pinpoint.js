...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("Pinpoint", "getApps", {
        // no params
        ...
        await Promise.all(data.ApplicationsResponse.Item.map(app => {
            ...
            return Promise.all([
                context.sdkcall("Pinpoint", "getConfigurationSet", {
                ...
                context.sdkcall("Pinpoint", "getCampaigns", {
                    ApplicationId: app.Id
                }, false).then(async (data) => {
                ...
                context.sdkcall("Pinpoint", "getSegments", {
                    ApplicationId: app.Id
                }, false).then(async (data) => {
                ...
                context.sdkcall("Pinpoint", "getEventStream", {
                    ApplicationId: app.Id
                }, false).then(async (data) => {
                    resources.push({
                ...
                context.sdkcall("Pinpoint", "getAdmChannel", {
                    ApplicationId: app.Id
                }, false).then(async (data) => {
                    resources.push({
                ...
                context.sdkcall("Pinpoint", "getApnsChannel", {
                    ApplicationId: app.Id
                }, false).then(async (data) => {
                    resources.push({
                ...
                context.sdkcall("Pinpoint", "getApnsSandboxChannel", {
                    ApplicationId: app.Id
                }, false).then(async (data) => {
                    resources.push({
                ...
                context.sdkcall("Pinpoint", "getApnsVoipChannel", {
                    ApplicationId: app.Id
                }, false).then(async (data) => {
                    resources.push({
                ...
                context.sdkcall("Pinpoint", "getApnsVoipSandboxChannel", {
                    ApplicationId: app.Id
                }, false).then(async (data) => {
                    resources.push({
                ...
                context.sdkcall("Pinpoint", "getBaiduChannel", {
                    ApplicationId: app.Id
                }, false).then(async (data) => {
                    resources.push({
                ...
                context.sdkcall("Pinpoint", "getEmailChannel", {
                    ApplicationId: app.Id
                }, false).then(async (data) => {
                    resources.push({
                ...
                context.sdkcall("Pinpoint", "getGcmChannel", {
                    ApplicationId: app.Id
                }, false).then(async (data) => {
                    resources.push({
                ...
                context.sdkcall("Pinpoint", "getSmsChannel", {
                    ApplicationId: app.Id
                }, false).then(async (data) => {
                    resources.push({
                ...
                context.sdkcall("Pinpoint", "getVoiceChannel", {
                    ApplicationId: app.Id
                }, false).then(async (data) => {
                    resources.push({
    ...
    await context.sdkcall("PinpointEmail", "listConfigurationSets", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.ConfigurationSets.map(configurationset => {
            return context.sdkcall("PinpointEmail", "getConfigurationSet", {
                ...
                await context.sdkcall("PinpointEmail", "getConfigurationSetEventDestinations", {
    ...
    await context.sdkcall("PinpointEmail", "listDedicatedIpPools", {
        // no params
    }, true).then(async (data) => {
    ...
    await context.sdkcall("PinpointEmail", "listEmailIdentities", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.EmailIdentities.map(emailidentity => {
            return context.sdkcall("PinpointEmail", "getEmailIdentity", {
    ...
    await context.sdkcall("Pinpoint", "listTemplates", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.TemplatesResponse.Item.map(template => {
            if (template.TemplateType == "EMAIL") {
                return context.sdkcall("Pinpoint", "getEmailTemplate", {
                ...
                return context.sdkcall("Pinpoint", "getSmsTemplate", {
                    TemplateName: template.TemplateName
                }, true).then(async (data) => {
                    resources.push({
                ...
                return context.sdkcall("Pinpoint", "getPushTemplate", {
                    TemplateName: template.TemplateName
                }, true).then(async (data) => {
                    resources.push({
                ...
                return context.sdkcall("Pinpoint", "getInAppTemplate", {
                    TemplateName: template.TemplateName
                }, true).then(async (data) => {
                    resources.push({
