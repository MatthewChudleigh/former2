...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("ElastiCache", "describeCacheClusters", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("ElastiCache", "describeReplicationGroups", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("ElastiCache", "describeCacheSubnetGroups", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("ElastiCache", "describeCacheParameterGroups", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("ElastiCache", "describeCacheSecurityGroups", {
        // no params
    }, false).then((data) => {
    ...
    await context.sdkcall("ElastiCache", "describeGlobalReplicationGroups", {
        // no params
    }, false).then((data) => {
    ...
    await context.sdkcall("ElastiCache", "describeUsers", {
        // no params
    }, false).then((data) => {
    ...
    await context.sdkcall("ElastiCache", "describeUserGroups", {
        // no params
    }, false).then((data) => {
