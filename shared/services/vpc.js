...
async function updateDatatable(context) {
    ...
    await context.sdkcall("EC2", "describeVpcs", {
        // no params
    }, true).then((data) => {
        return Promise.all(data.Vpcs.map(vpc => {
            if (vpc.IsDefault && !context.include_default_resources) {
                ...
                return context.sdkcall("EC2", "describeVpcAttribute", {
                    Attribute: "enableDnsSupport",
                    VpcId: vpc.VpcId
                }, true).then(async (dnsSupport) => {
                    await context.sdkcall("EC2", "describeVpcAttribute", {
    ...
    await context.sdkcall("EC2", "describeSubnets", {
        // no params
        ...
        data.Subnets.forEach(async (subnet) => {
            if (subnet.VpcId != defaultVPC) {
                ...
                subnet['Tags'] = await context.getResourceTags(subnet.SubnetArn);
    ...
    await context.sdkcall("EC2", "describeEgressOnlyInternetGateways", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("EC2", "describeCustomerGateways", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("EC2", "describeVpnGateways", {
        // no params
    }, true).then(async (data) => {
        ...
        await context.sdkcall("EC2", "describeInternetGateways", {
            // no params
        }, true).then((data) => {
    ...
    await context.sdkcall("EC2", "describeAddresses", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("EC2", "describeDhcpOptions", {
        // no params
    }, true).then((data) => {
        data.DhcpOptions.forEach(dhcpOptions => {
            if (
                ...
                context.include_default_resources
            ) {
                resources.push({
    ...
    await context.sdkcall("EC2", "describeVpnConnections", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("EC2", "describeVpcPeeringConnections", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("EC2", "describeNetworkAcls", {
        // no params
    }, true).then((data) => {
        data.NetworkAcls.forEach(networkAcl => {
            if (!networkAcl.IsDefault || context.include_default_resources) {
    ...
    await context.sdkcall("EC2", "describeRouteTables", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("EC2", "describeTransitGateways", {
        // no params
    }, false).then((data) => {
    ...
    await context.sdkcall("EC2", "describeTransitGatewayRouteTables", {
        // no params
        ...
        await Promise.all(data.TransitGatewayRouteTables.map(transitGatewayRouteTable => {
            ...
            return Promise.all([
                context.sdkcall("EC2", "searchTransitGatewayRoutes", {
                ...
                context.sdkcall("EC2", "getTransitGatewayRouteTableAssociations", {
                    TransitGatewayRouteTableId: transitGatewayRouteTable.TransitGatewayRouteTableId
                }, true).then((data) => {
                ...
                context.sdkcall("EC2", "getTransitGatewayRouteTablePropagations", {
                    TransitGatewayRouteTableId: transitGatewayRouteTable.TransitGatewayRouteTableId
                }, true).then((data) => {
    ...
    await context.sdkcall("EC2", "describeTransitGatewayVpcAttachments", {
        // no params
    }, false).then((data) => {
    ...
    await context.sdkcall("EC2", "describeVpcEndpoints", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("EC2", "describeVpcEndpointConnectionNotifications", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("EC2", "describeVpcEndpointServices", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.ServiceDetails.map(serviceDetail => {
            if (serviceDetail.ServiceName.startsWith("vpce-svc-")) {
                ...
                return context.sdkcall("EC2", "describeVpcEndpointServicePermissions", {
    ...
    await context.sdkcall("EC2", "describeNatGateways", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("EC2", "describeClientVpnEndpoints", {
        // no params
    }, false).then(async (data) => {
        if (data.ClientVpnEndpoints) {
            await Promise.all(data.ClientVpnEndpoints.map(async (endpoint) => {
                ...
                return Promise.all([
                    context.sdkcall("EC2", "describeClientVpnRoutes", {
                    ...
                    context.sdkcall("EC2", "describeClientVpnTargetNetworks", {
                        ClientVpnEndpointId: endpoint.ClientVpnEndpointId
                    }, true).then((data) => {
                    ...
                    context.sdkcall("EC2", "describeClientVpnAuthorizationRules", {
                        ClientVpnEndpointId: endpoint.ClientVpnEndpointId
                    }, true).then((data) => {
    ...
    await context.sdkcall("EC2", "describeTrafficMirrorFilters", {
        // no params
    }, false).then((data) => {
    ...
    await context.sdkcall("EC2", "describeTrafficMirrorSessions", {
        // no params
    }, false).then((data) => {
    ...
    await context.sdkcall("EC2", "describeTrafficMirrorTargets", {
        // no params
    }, false).then((data) => {
    ...
    await context.sdkcall("EC2", "describeLocalGatewayRouteTables", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.LocalGatewayRouteTables.map(async (localgatewayroutetable) => {
            await context.sdkcall("EC2", "searchLocalGatewayRoutes", {
    ...
    await context.sdkcall("EC2", "describeLocalGatewayRouteTableVpcAssociations", {
        // no params
    }, false).then((data) => {
    ...
    await context.sdkcall("NetworkManager", "describeGlobalNetworks", {
        // no params
    }, false).then(async (data) => {
        data.GlobalNetworks.forEach(async (globalnetwork) => {
            ...
            await Promise.all([
                context.sdkcall("NetworkManager", "getSites", {
                ...
                context.sdkcall("NetworkManager", "getDevices", {
                    GlobalNetworkId: globalnetwork.GlobalNetworkId
                }, false).then((data) => {
                ...
                context.sdkcall("NetworkManager", "getLinks", {
                    GlobalNetworkId: globalnetwork.GlobalNetworkId
                }, false).then((data) => {
                ...
                context.sdkcall("NetworkManager", "getLinkAssociations", {
                    GlobalNetworkId: globalnetwork.GlobalNetworkId
                }, false).then((data) => {
                ...
                context.sdkcall("NetworkManager", "getCustomerGatewayAssociations", {
                    GlobalNetworkId: globalnetwork.GlobalNetworkId
                }, false).then((data) => {
                ...
                context.sdkcall("NetworkManager", "getTransitGatewayRegistrations", {
                    GlobalNetworkId: globalnetwork.GlobalNetworkId
                }, false).then((data) => {
    ...
    await context.sdkcall("NetworkManager", "listCoreNetworks", {
        // no params
    }, false).then(async (data) => {
        data.CoreNetworks.forEach(async (corenetwork) => {
            await Promise.all([
                context.sdkcall("NetworkManager", "getCoreNetworkPolicy", {
                ...
                context.sdkcall("NetworkManager", "listAttachments", {
                    CoreNetworkId: corenetwork.CoreNetworkId,
                    AttachmentType: 'CONNECT'
                }, false).then(async (data) => {
                    await Promise.all(data.Attachments.map(async (attachment) => {
                        await context.sdkcall("NetworkManager", "getConnectAttachment", {
                        ...
                        return context.sdkcall("NetworkManager", "listConnectPeers", {
                            ...
                            await Promise.all(data.ConnectPeers.map(connectpeer => {
                                return context.sdkcall("NetworkManager", "getConnectPeer", {
                ...
                context.sdkcall("NetworkManager", "listAttachments", {
                    ...
                    await Promise.all(data.Attachments.forEach(attachment => {
                        return context.sdkcall("NetworkManager", "getSiteToSiteVpnAttachment", {
                            AttachmentId: attachment.AttachmentId
                        }, false).then(async (data) => {
                            resources.push({
                ...
                context.sdkcall("NetworkManager", "listAttachments", {
                    ...
                    await Promise.all(data.Attachments.forEach(attachment => {
                        return context.sdkcall("NetworkManager", "getVpcAttachment", {
                            AttachmentId: attachment.AttachmentId
                        }, false).then(async (data) => {
                            resources.push({
    ...
    await context.sdkcall("EC2", "describeManagedPrefixLists", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.PrefixLists.map(prefixlist => {
            return context.sdkcall("EC2", "getManagedPrefixListEntries", {
    ...
    await context.sdkcall("EC2", "describeCarrierGateways", {
        // no params
    }, false).then(async (data) => {
    ...
    await context.sdkcall("NetworkFirewall", "listFirewalls", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.Firewalls.map(async (firewall) => {
            await context.sdkcall("NetworkFirewall", "describeFirewall", {
            ...
            return context.sdkcall("NetworkFirewall", "describeLoggingConfiguration", {
                FirewallName: firewall.FirewallName
            }, false).then((data) => {
                resources.push({
    ...
    await context.sdkcall("NetworkFirewall", "listFirewallPolicies", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.FirewallPolicies.map(firewallpolicy => {
            return context.sdkcall("NetworkFirewall", "describeFirewallPolicy", {
    ...
    await context.sdkcall("NetworkFirewall", "listRuleGroups", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.RuleGroups.map(rulegroup => {
            return context.sdkcall("NetworkFirewall", "describeRuleGroup", {
    ...
    await context.sdkcall("EC2", "describeNetworkInsightsPaths", {
        // no params
    }, false).then(async (data) => {
    ...
    await context.sdkcall("EC2", "describeNetworkInsightsAnalyses", {
        // no params
    }, false).then(async (data) => {
    ...
    await context.sdkcall("EC2", "describeTransitGatewayMulticastDomains", {
        // no params
    }, false).then(async (data) => {
        data.TransitGatewayMulticastDomainIds.forEach(async (id) => {
            ...
            await context.sdkcall("EC2", "getTransitGatewayMulticastDomainAssociations", {
            ...
            await context.sdkcall("EC2", "searchTransitGatewayMulticastGroups", {
                TransitGatewayMulticastDomainId: id
            }, false).then(async (data) => {
    ...
    await context.sdkcall("EC2", "describeTransitGatewayConnects", {
        // no params
    }, false).then(async (data) => {
    ...
    await context.sdkcall("EC2", "describeTransitGatewayPeeringAttachments", {
        // no params
    }, false).then(async (data) => {
    ...
    await context.sdkcall("EC2", "describeNetworkInsightsAccessScopes", {
        // no params
    }, false).then(async (data) => {
