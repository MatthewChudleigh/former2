...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("DataSync", "listAgents", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.Agents.map(agent => {
            return context.sdkcall("DataSync", "describeAgent", {
    ...
    await context.sdkcall("DataSync", "listTasks", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.Tasks.map(task => {
            return context.sdkcall("DataSync", "describeTask", {
    ...
    await context.sdkcall("DataSync", "listLocations", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.Locations.map(location => {
            ...
            if (location.LocationUri.split(":")[0].toUpperCase() == "EFS") {
                return context.sdkcall("DataSync", "describeLocationEfs", {
                ...
                return context.sdkcall("DataSync", "describeLocationNfs", {
                    LocationArn: location.LocationArn
                }, true).then((data) => {
                    resources.push({
                        f2id: data.LocationArn,
                ...
                return context.sdkcall("DataSync", "describeLocationS3", {
                    LocationArn: location.LocationArn
                }, true).then((data) => {
                    resources.push({
                        f2id: data.LocationArn,
                ...
                return context.sdkcall("DataSync", "describeLocationFsxWindows", {
                    LocationArn: location.LocationArn
                }, true).then((data) => {
                    resources.push({
                        f2id: data.LocationArn,
                ...
                return context.sdkcall("DataSync", "describeLocationFsxLustre", {
                    LocationArn: location.LocationArn
                }, true).then((data) => {
                    resources.push({
                        f2id: data.LocationArn,
                ...
                return context.sdkcall("DataSync", "describeLocationFsxOpenZfs", {
                    LocationArn: location.LocationArn
                }, true).then((data) => {
                    resources.push({
                        f2id: data.LocationArn,
                ...
                return context.sdkcall("DataSync", "describeLocationFsxOntap", {
                    LocationArn: location.LocationArn
                }, true).then((data) => {
                    resources.push({
                        f2id: data.LocationArn,
                ...
                return context.sdkcall("DataSync", "describeLocationSmb", {
                    LocationArn: location.LocationArn
                }, true).then((data) => {
                    resources.push({
                        f2id: data.LocationArn,
                ...
                return context.sdkcall("DataSync", "describeLocationObjectStorage", {
                    LocationArn: location.LocationArn
                }, true).then((data) => {
                    resources.push({
                        f2id: data.LocationArn,
                ...
                return context.sdkcall("DataSync", "describeLocationHdfs", {
                    LocationArn: location.LocationArn
                }, true).then((data) => {
                    resources.push({
                        f2id: data.LocationArn,
