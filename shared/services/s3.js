...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("S3", "listBuckets", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.Buckets.map(bucket => {
            return Promise.all([
                context.sdkcall("S3", "getBucketAccelerateConfiguration", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                    bucket['AccelerateConfiguration'] = data;
                }).catch(() => { }),
                context.sdkcall("S3", "getBucketTagging", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                    bucket['Tags'] = data.TagSet;
                }).catch(() => { }),
                context.sdkcall("S3", "getBucketEncryption", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                    bucket['Encryption'] = data;
                }).catch(() => { }),
                context.sdkcall("S3", "getBucketCors", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                    bucket['Cors'] = data;
                }).catch(() => { }),
                context.sdkcall("S3", "getBucketLifecycleConfiguration", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                    bucket['Lifecycle'] = data;
                }).catch(() => { }),
                context.sdkcall("S3", "getBucketLogging", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                    bucket['Logging'] = data;
                }).catch(() => { }),
                context.sdkcall("S3", "getBucketNotificationConfiguration", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                    bucket['NotificationConfiguration'] = data;
                }).catch(() => { }),
                context.sdkcall("S3", "getBucketReplication", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                    bucket['Replication'] = data;
                }).catch(() => { }),
                context.sdkcall("S3", "getBucketVersioning", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                    bucket['Versioning'] = data;
                }).catch(() => { }),
                context.sdkcall("S3", "getBucketWebsite", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                    bucket['Website'] = data;
                }).catch(() => { }),
                context.sdkcall("S3", "listBucketAnalyticsConfigurations", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                    bucket['AnalyticsConfigurations'] = data;
                }).catch(() => { }),
                context.sdkcall("S3", "listBucketInventoryConfigurations", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                    bucket['InventoryConfigurations'] = data;
                }).catch(() => { }),
                context.sdkcall("S3", "listBucketMetricsConfigurations", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                    bucket['MetricsConfigurations'] = data;
                }).catch(() => { }),
                context.sdkcall("S3", "getObjectLockConfiguration", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                    bucket['ObjectLockConfiguration'] = data.ObjectLockConfiguration;
                }).catch(() => { }),
                context.sdkcall("S3", "listBucketIntelligentTieringConfigurations", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                    bucket['IntelligentTieringConfiguration'] = data.IntelligentTieringConfigurationList;
                }).catch(() => { }),
                context.sdkcall("S3", "getBucketOwnershipControls", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                    bucket['OwnershipControls'] = data.OwnershipControls;
                }).catch(() => { }),
                context.sdkcall("S3", "getPublicAccessBlock", {
                    Bucket: bucket.Name
                }, false).then((data) => {
                ...
                await context.sdkcall("S3", "getBucketPolicy", {
                    Bucket: bucket.Name
                }, false).then((data) => {
    ...
    await context.sdkcall("STS", "getCallerIdentity", {
        ...
        await context.sdkcall("S3Control", "listAccessPoints", {
            AccountId: accountId
        }, false).then(async (data) => {
            await Promise.all(data.AccessPointList.map(async (accessPoint) => {
                return context.sdkcall("S3Control", "getAccessPoint", {
                    AccountId: accountId,
                    Name: accessPoint.Name
                }, false).then(async (data) => {
                    await context.sdkcall("S3Control", "getAccessPointPolicy", {
                        AccountId: accountId,
                        Name: accessPoint.Name
        ...
        await context.sdkcall("S3Control", "listMultiRegionAccessPoints", {
            AccountId: accountId
        }, false).then(async (data) => {
            await Promise.all(data.AccessPoints.map(async (accessPoint) => {
                return context.sdkcall("S3Control", "getMultiRegionAccessPoint", {
                    AccountId: accountId,
                    Name: accessPoint.Name
                }, false).then(async (data) => {
                    ...
                    await context.sdkcall("S3Control", "getMultiRegionAccessPointPolicy", {
                        AccountId: accountId,
                        Name: accessPoint.Name
                    }, false).then(async (policydata) => {
        ...
        await context.sdkcall("S3Control", "listStorageLensConfigurations", {
            AccountId: accountId
        }, true).then(async (data) => {
            await Promise.all(data.StorageLensConfigurationList.map(config => {
                return context.sdkcall("S3Control", "getStorageLensConfiguration", {
                    ConfigId: config.Id,
                    AccountId: accountId
                }, true).then((data) => {
                    resources.push({
        ...
        await context.sdkcall("S3Control", "listRegionalBuckets", {
            AccountId: accountId
        }, false).then(async (data) => {
            await Promise.all(data.RegionalBucketList.map(async (bucket) => {
                await context.sdkcall("S3Control", "getBucket", {
                    Bucket: bucket.Bucket,
                    AccountId: accountId
                }, true).then(async (data) => {
                    data['OutpostId'] = bucket.OutpostId;

                    await context.sdkcall("S3Control", "getBucketLifecycleConfiguration", {
                        Bucket: bucket.Bucket,
                        AccountId: accountId
                ...
                return context.sdkcall("S3Control", "getBucketPolicy", {
                    Bucket: bucket.Bucket,
                    AccountId: accountId
                }, true).then((data) => {
        ...
        await context.sdkcall("S3Control", "listAccessPointsForObjectLambda", {
            AccountId: accountId
        }, true).then(async (data) => {
            await Promise.all(data.ObjectLambdaAccessPointList.map(async (accesspoint) => {
                await context.sdkcall("S3Control", "getAccessPointConfigurationForObjectLambda", {
                    Name: accesspoint.Name,
                    AccountId: accountId
                }, true).then((data) => {
                ...
                return context.sdkcall("S3Control", "getAccessPointPolicyForObjectLambda", {
                    Name: accesspoint.Name,
                    AccountId: accountId
                }, true).then((data) => {
    ...
    await context.sdkcall("S3Outposts", "listEndpoints", {
        // no params
    }, false).then(async (data) => {
