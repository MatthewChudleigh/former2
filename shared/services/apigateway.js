...
async function updateDatatable(context) {
    const resources = [];
    // V1
    await context.sdkcall("APIGateway", "getAccount", {
        // no params
    }, true).then((data) => {
        if (
    ...
    await context.sdkcall("APIGateway", "getClientCertificates", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("APIGateway", "getApiKeys", {
        // no params
    }, true).then((data) => {
    ...
    // V1
    await context.sdkcall("APIGateway", "getVpcLinks", {
        // no params
    }, true).then((data) => {
    ...
    // V2
    await context.sdkcall("ApiGatewayV2", "getVpcLinks", {
        // no params
    }, false).then((data) => {
        data.Items.forEach(vpcLink => {
            resources.push({
    ...
    // V1
    await context.sdkcall("APIGateway", "getUsagePlans", {
        // no params
        ...
        await Promise.all(data.items.map(usagePlan => {
            ...
            return context.sdkcall("APIGateway", "getUsagePlanKeys", {
    ...
    await context.sdkcall("APIGateway", "getRestApis", {
        // no params
    }, true).then(async (restapis) => {
        await context.sdkcall("APIGateway", "getDomainNames", {
            // no params
        }, true).then(async (data) => {
            await Promise.all(data.items.map(domainName => {
                ...
                return context.sdkcall("APIGateway", "getBasePathMappings", {
                    domainName: domainName.domainName
                }, true).then((data) => {
        ...
        await Promise.all(restapis.items.map(async (api) => {
            ...
            await Promise.all([
                context.sdkcall("APIGateway", "getRequestValidators", {
                    restApiId: api.id
                }, true).then((data) => {
                    if (data.item) {
                ...
                context.sdkcall("APIGateway", "getDocumentationParts", {
                    restApiId: api.id
                }, true).then((data) => {
                    if (data.item) {
                ...
                context.sdkcall("APIGateway", "getDocumentationVersions", {
                    restApiId: api.id
                }, true).then((data) => {
                    if (data.item) {
                ...
                context.sdkcall("APIGateway", "getGatewayResponses", {
                    restApiId: api.id
                }, true).then((data) => {
                    if (data.item) {
                ...
                context.sdkcall("APIGateway", "getStages", {
                    restApiId: api.id
                }, true).then((data) => {
                ...
                context.sdkcall("APIGateway", "getDeployments", {
                    restApiId: api.id
                }, true).then((data) => {
                ...
                context.sdkcall("APIGateway", "getResources", {
                    restApiId: api.id,
                    limit: 500
                }, true).then((data) => {
                    if (data.items) {
                        data.items.forEach(async (resource) => {
                            if (resource.resourceMethods) {
                                await Promise.all(Object.keys(resource.resourceMethods).map(resourceMethod => {
                                    return context.sdkcall("APIGateway", "getMethod", {
                ...
                context.sdkcall("APIGateway", "getModels", {
                    restApiId: api.id
                }, true).then((data) => {
                ...
                context.sdkcall("APIGateway", "getAuthorizers", {
                    restApiId: api.id
                }, true).then((data) => {
    ...
    // V2
    await context.sdkcall("ApiGatewayV2", "getApis", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.Items.map(api => {
            ...
            return Promise.all([
                context.sdkcall("ApiGatewayV2", "getStages", {
                    ApiId: api.ApiId
                }, true).then((data) => {
                ...
                context.sdkcall("ApiGatewayV2", "getDeployments", {
                    ApiId: api.ApiId
                }, true).then((data) => {
                    data.Items.forEach(deployment => {
                ...
                context.sdkcall("ApiGatewayV2", "getModels", {
                    ApiId: api.ApiId
                }, true).then((data) => {
                    data.Items.forEach(model => {
                ...
                context.sdkcall("ApiGatewayV2", "getAuthorizers", {
                    ApiId: api.ApiId
                }, true).then((data) => {
                    data.Items.forEach(authorizer => {
                ...
                context.sdkcall("ApiGatewayV2", "getRoutes", {
                    ApiId: api.ApiId
                }, true).then(async (data) => {
                    await Promise.all(data.Items.map(route => {
                        ...
                        return context.sdkcall("ApiGatewayV2", "getRouteResponses", {
                            ApiId: api.ApiId,
                ...
                context.sdkcall("ApiGatewayV2", "getIntegrations", {
                    ApiId: api.ApiId
                }, true).then(async (data) => {
                    await Promise.all(data.Items.map(integration => {
                        ...
                        return context.sdkcall("ApiGatewayV2", "getIntegrationResponses", {
                            ApiId: api.ApiId,
        ...
        await context.sdkcall("ApiGatewayV2", "getDomainNames", {
            // no params
        }, true).then(async (data) => {
            await Promise.all(data.Items.map(domainName => {
                ...
                return context.sdkcall("ApiGatewayV2", "getApiMappings", {
                    DomainName: domainName.DomainName
                }, true).then((data) => {
