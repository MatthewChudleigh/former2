...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("EventBridge", "listRules", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.Rules.map(rule => {
            return context.sdkcall("EventBridge", "describeRule", {
                Name: rule.Name
            }, true).then(async (data) => {
                await context.sdkcall("EventBridge", "listTargetsByRule", {
                    Rule: data.Name
                }, true).then((targets) => {
    ...
    await context.sdkcall("Pipes", "listPipes", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.Pipes.map(pipe => {
            return context.sdkcall("Pipes", "describePipe", {
                Name: pipe.Name
            }, true).then(async (data) => {
                resources.push({
                    f2id: data.Arn,
    ...
    await context.sdkcall("EventBridge", "listEventBuses", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.EventBuses.map(async (eventBus) => {
            ...
            return context.sdkcall("EventBridge", "describeEventBus", {
                Name: eventBus.Name
            }, true).then(async (data) => {
    ...
    await context.sdkcall("Schemas", "listRegistries", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.Registries.map(async (registry) => {
            ...
            return Promise.all([
                context.sdkcall("Schemas", "describeRegistry", {
                ...
                context.sdkcall("Schemas", "listSchemas", {
                    RegistryName: registry.RegistryName
                }, true).then(async (data) => {
                    await Promise.all(data.Schemas.map(async (schema) => {
                        return context.sdkcall("Schemas", "describeSchema", {
                            RegistryName: registry.RegistryName,
                ...
                context.sdkcall("Schemas", "getResourcePolicy", {
                    RegistryName: registry.RegistryName
                }, true).then(async (data) => {
                    data['RegistryName'] = registry.RegistryName;
    ...
    await context.sdkcall("Schemas", "listDiscoverers", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.Discoverers.map(async (discoverer) => {
            return context.sdkcall("Schemas", "describeDiscoverer", {
    ...
    await context.sdkcall("EventBridge", "listArchives", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.Archives.map(async (archive) => {
            return context.sdkcall("EventBridge", "describeArchive", {
    ...
    await context.sdkcall("EventBridge", "listApiDestinations", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.ApiDestinations.map(async (apidestination) => {
            return context.sdkcall("EventBridge", "describeApiDestination", {
    ...
    await context.sdkcall("EventBridge", "listConnections", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.Connections.map(async (connection) => {
            return context.sdkcall("EventBridge", "describeConnection", {
    ...
    await context.sdkcall("EventBridge", "listEndpoints", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.Endpoints.map(async (endpoint) => {
            return context.sdkcall("EventBridge", "describeEndpoint", {
                Name: endpoint.Name
            }, true).then(async (data) => {
                resources.push({
                    f2id: data.Arn,
    ...
    await context.sdkcall("Scheduler", "listSchedules", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.Schedules.map(async (schedule) => {
            return context.sdkcall("Scheduler", "getSchedule", {
                Name: schedule.Name
            }, true).then(async (data) => {
                resources.push({
                    f2id: data.Arn,
    ...
    await context.sdkcall("Scheduler", "listScheduleGroups", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.ScheduleGroups.map(async (schedulegroup) => {
            return context.sdkcall("Scheduler", "getScheduleGroup", {
