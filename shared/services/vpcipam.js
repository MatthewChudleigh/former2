...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("EC2", "describeIpams", {
        // no params
    ...
    await context.sdkcall("EC2", "describeIpamPools", {
        // no params
    }, false).then(async (data) => {
        data.IpamPools.forEach(async (ipampool) => {
            ...
            await context.sdkcall("EC2", "getIpamPoolAllocations", {
    ...
    await context.sdkcall("EC2", "describeIpamScopes", {
        // no params
    }, false).then(async (data) => {
