...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("Redshift", "describeClusters", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("Redshift", "describeClusterSubnetGroups", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("Redshift", "describeClusterParameterGroups", {
        // no params
    }, true).then((data) => {
    ...
    await context.sdkcall("Redshift", "describeClusterSecurityGroups", {
        // no params
    }, false).then((data) => {
    ...
    await context.sdkcall("Redshift", "describeEndpointAccess", {
        // no params
    }, false).then((data) => {
    ...
    await context.sdkcall("Redshift", "describeEndpointAuthorization", {
        // no params
    }, false).then((data) => {
    ...
    await context.sdkcall("Redshift", "describeEventSubscriptions", {
        // no params
    }, false).then((data) => {
    ...
    await context.sdkcall("Redshift", "describeScheduledActions", {
        // no params
    }, false).then((data) => {
    ...
    await context.sdkcall("RedshiftServerless", "listNamespaces", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.namespaces.map(async (namespace) => {
            return context.sdkcall("RedshiftServerless", "getNamespace", {
    ...
    await context.sdkcall("RedshiftServerless", "listWorkgroups", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.workgroups.map(async (workgroup) => {
            return context.sdkcall("RedshiftServerless", "getWorkgroup", {
