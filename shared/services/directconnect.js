...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("DirectConnect", "describeConnections", {
        // no params
        ...
        await Promise.all(data.connections.map(connection => {
            ...
            return context.sdkcall("DirectConnect", "describeVirtualInterfaces", {
    ...
    await context.sdkcall("DirectConnect", "describeLags", {
        // no params
    }, true).then(async (data) => {
    ...
    await context.sdkcall("DirectConnect", "describeDirectConnectGateways", {
        // no params
    }, true).then(async (data) => {
        await Promise.all(data.directConnectGateways.map(gateway => {
            ...
            return context.sdkcall("DirectConnect", "describeDirectConnectGatewayAssociations", {
                ...
                await Promise.all(data.directConnectGatewayAssociations.map(association => {
                    ...
                    return context.sdkcall("DirectConnect", "describeDirectConnectGatewayAssociationProposals", {
                        directConnectGatewayId: gateway.directConnectGatewayId,
                        associatedGatewayId: association.associatedGateway.id
                    }, true).then(async (data) => {
