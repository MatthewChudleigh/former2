...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("Neptune", "describeDBClusters", {
        Filters: [{
            Name: 'engine',
            Values: ['neptune']
        }]
    ...
    await context.sdkcall("Neptune", "describeDBInstances", {
        Filters: [{
            Name: 'engine',
            Values: ['neptune']
        }]
    ...
    await context.sdkcall("Neptune", "describeDBClusterParameterGroups", {
        Filters: [{
            Name: 'engine',
            Values: ['neptune']
        }]
        ...
        await Promise.all(data.DBClusterParameterGroups.map(parameterGroup => {
            return context.sdkcall("Neptune", "describeDBClusterParameters", {
    ...
    await context.sdkcall("Neptune", "describeDBParameterGroups", {
        Filters: [{
            Name: 'engine',
            Values: ['neptune']
        }]
        ...
        await Promise.all(data.DBParameterGroups.map(parameterGroup => {
            return context.sdkcall("Neptune", "describeDBParameters", {
    ...
    await context.sdkcall("Neptune", "describeDBSubnetGroups", {
        // no params
    }, true).then((data) => {
