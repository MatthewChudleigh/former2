...
async function updateDatatable(context) {
    const resources = [];
    await context.sdkcall("Personalize", "listDatasets", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.datasets.map(async (dataset) => {
            return context.sdkcall("Personalize", "describeDataset", {
    ...
    await context.sdkcall("Personalize", "listDatasetGroups", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.datasetGroups.map(async (datasetgroup) => {
            return context.sdkcall("Personalize", "describeDatasetGroup", {
    ...
    await context.sdkcall("Personalize", "listSchemas", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.schemas.map(async (schema) => {
            return context.sdkcall("Personalize", "describeSchema", {
    ...
    await context.sdkcall("Personalize", "listSolutions", {
        // no params
    }, false).then(async (data) => {
        await Promise.all(data.solutions.map(async (solution) => {
            return context.sdkcall("Personalize", "describeSolution", {
